...
function OnActionPressed(player, action, value)
    ...
    if action == "Weapon Slot 6" then
        AssignSlotWeapon(player, 6)
    end
    if action == "Weapon Slot 7" then
        AssignSlotWeapon(player, 7)
    end
    if action == "Weapon Slot 8" then
        AssignSlotWeapon(player, 8)
    end
end
