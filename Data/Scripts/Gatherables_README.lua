--[[
    ...
    Gatherable configuration lives in a couple of places. One set of properties that control an entire group of objects,
    ...
    Each Gatherable object inside the "Gatherable Group" also has its configuration values. This lets you customize
    ...
    3. InteractionError
        ...
        - An error that is broadcast if the Player tries to interact with this Gatherable with the wrong tool.
    ...
    These values drive the behaviors around dropping items in the world or directly into a Players Inventory. You can
    ...
    9. DropItemPickupTemplate
        ...
        - If DropOnGather is true, this Item Pickup template will be spawned in the world to contain the drop.
