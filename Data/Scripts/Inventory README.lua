--[[
    ...
    3. Inventory Settings
        ...
        - This is a stripped down Inventory meant for more advanced creators to build their Inventory systems. You
    ...
    4. Container Inventory
        ...
        their items in it. Think of it like a Player Stash. These container Inventories can also potentially be
    ...
    13. APIInventory.Events.SlotRightClicked = "INV_slotRightClicked"

        - Handler = function(player, inventoryId, slotIndex) - Client Only

        - Sent from the provided InventoryScreenSlot when right-clicked. If a custom UI is created this Event will need to be
        sent in the same manner for the action to work.
    ...
    The hierarchy for the screen is quite simple and should be easy to update with your art. If you want to maintain
    ...
    1. Controller
        ...
        Inventory Screen Slot script. A custom script should have the following method on it to work with the system:
            ...
            Initialize(inventoryId, slotIndex, inventoryItem, cameraId, binding, actsAsBinding)
    ...
    The hierarchy for the slot is quite simple and should be easy to update with your art. If you want to maintain
    functionality, be sure to only adjust and add art without removing the Interaction System Components.
