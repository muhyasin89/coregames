--[[
    ...
    Target to become interactable. For an example, you can look at the code in GatherableGroup.lua to see how it
    registers the Gatherable Objects as targets when they spawn.

    To create your Equipment Target you need to have a script that will register it. You will also need to make sure
