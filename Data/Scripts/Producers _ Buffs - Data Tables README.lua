--[[
    ...
    were designed with farming or crops in mind, but can be used for a multitude of other cases. Some ideas:
    ...
    whether they are placed by the creator or Players.
        ...
        3. Add columns (if needed) and rows to the Placeables table for each Producer you want and fill in the fields.
            ...
            i. RotationSnapAngle (Float)
                ...
                - The angle increment to snap rotation of the item too if "SnapRotation" is true.
            ...
            b. CostCurrencyId[n] (String)
                ...
                - (Optional) If set this should point to a Currency Id. This Currency will be removed from the Player
            ...
            b. ProducerBuffIds (String)
                ...
                - (Optional) A comma-separated list of Ids that exist in the Producer Buffs Data Table. These buffs are
            ...
            d. BuildRate (Float)
                ...
                - The build rate is a multiplier. If a Producer has a BuildSeconds of 10 seconds, but the BuildRate is
            ...
            f. ExpireRate (Float)
                ...
                - The Expire Rate is a multiplier. If a Producer has a ExpireSeconds of 10 seconds, but the ExpireRate
    ...
    Placeables can also be removed by broadcasting your events.
