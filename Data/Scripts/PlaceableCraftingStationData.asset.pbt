Assets {
  Id: 13828604279734172750
  Name: "PlaceableCraftingStationData"
  PlatformAssetType: 3
  TextAsset {
    CustomParameters {
      Overrides {
      ...
      Overrides {
        Name: "cs:IsCraftingStation"
        Bool: true
      }
      Overrides {
        Name: "cs:ValidCraftToolTypes"
        String: "hand"
      }
      Overrides {
        Name: "cs:OpenCraftingStationInteractionText"
        String: ""
      }
      Overrides {
        Name: "cs:CraftRate"
      ...
      Overrides {
        Name: "cs:AllowRemovalWhileInUse"
        Bool: false
      }
      Overrides {
        Name: "cs:DestroyCraftOnRemove"
        Bool: false
      }
      Overrides {
        Name: "cs:DropCraftInWorldOnRemove"
        Bool: false
      }
      Overrides {
      ...
      Overrides {
        Name: "cs:IsCraftingStation:tooltip"
        String: "If true, this Placeable object will act as an Inventory Container."
      }
      Overrides {
        Name: "cs:IsCraftingStation:category"
        String: "Crafting"
      }
      Overrides {
        Name: "cs:ValidCraftToolTypes:tooltip"
      ...
      Overrides {
        Name: "cs:ValidCraftToolTypes:category"
        String: "Crafting"
      }
      Overrides {
        Name: "cs:OpenCraftingStationInteractionText:category"
        String: "Crafting"
      }
      Overrides {
        Name: "cs:AllowRemovalWhileInUse:tooltip"
        String: "If true, this will allow Players to remove this Placeable Inventory if it contains items."
      }
      Overrides {
        Name: "cs:AllowRemovalWhileInUse:category"
        String: "Crafting"
      }
      Overrides {
        Name: "cs:DestroyCraftOnRemove:tooltip"
        String: "If true, and \"AllowNonEmptyRemoval\" is also true, this will destroy the contents of the Inventory when it is removed."
      }
      Overrides {
        Name: "cs:DestroyCraftOnRemove:category"
        String: "Crafting"
      }
      Overrides {
        Name: "cs:DropCraftInWorldOnRemove:tooltip"
      ...
      Overrides {
        Name: "cs:DropCraftInWorldOnRemove:category"
        String: "Crafting"
      }
      Overrides {
        Name: "cs:CraftRate:category"
        String: "Crafting"
      }
    }
  }
