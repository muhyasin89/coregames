--[[
    ...
    run fairly efficiently at scale. Gatherables are more efficient when you want many objects in your scene, so it
    ...
    during gameplay. In most cases, you will also want to use Player Lots to allow placed Producers to be saved to the
    Players Storage.
    ...
    whether they are placed by the creator or Players.
        ...
        2. Drop a "PlaceableProducerBaseData" script into that "Placeables" group as a child.
        ...
        4. Fill in the Placeable Producer Base Data Custom Properties.
            ...
            h. SnapRotation
                ...
                - If true, the rotation will be snapped in increments of the angle set by "RotationSnapAngle".
            ...
            b. DropInWorldOnRemove
                ...
                - If true, drops will appear in the world as Item Pickups when the item is removed. Otherwise, they will go
            ...
            e. DropItemPickupTemplate
                ...
                - If true, and if "DropInWorldOnRemove" is true, this Item Pickup template will be spawned in the world to
                contain the drops.
    ...
    contain any collision you need. "Server" is just there if you have any specific server-only logic you would like to
    ...
    Producer Base. For example, a plant Producer would be placed into a soil Producer Base.
        ...
        2. Drop a "ProducerData" script into that "Producers" group as a child.
        ...
        4. Fill in the Producer Data Custom Properties.
            ...
            f. RebuildSeconds
                ...
                - After the first collect of a Producer, this is the number of seconds its takes for the Producer to
                rebuild.

            g. AutoBuild

                - If true, once you place a Producer on a Producer Base, it will begin building and doesn't require
            ...
            j. ReplacementProducerId
                ...
                Producer when it's been collected for the final time. This can be a comma-separated list if you want a
            ...
            c. CanExpireInPlacedState
                ...
                - Tick if this Producer is able to expire when it's in the placed state.
            ...
            e. CanExpireInReadyState
                ...
                - Tick if this Producer is able to expire when it's in the ready state.
            ...
            c. DropItemPickupTemplate
                ...
                - If "DropOnCollect" is true, this Item Pickup template will be spawned in the world to contain the drop.
    ...
    Placeable Producers can be placed into Placeable Replicators onto valid Placement Areas.
        ...
        2. Build out a set of objects in a group that defines a Placement Area. This will be an area where specific
    ...
    Every Buff needs a BuffData to define some basic data.
        ...
        2. Drop a "BuffData" script into that "Buffs" group as a child.
        ...
        modifying a Producer. Name this Data after the Buff Id you are referencing and fill in the Custom Properties.
            ...
            a. CanReceive
                ...
                - Tick to be able to receive this Buff.
    ...
    Producer Bases can also be manipulated by broadcasting your events.
