--[[
    ...
    Players enter and exit them. This is used to create things like the interior of a Player's house that only loads when
    a Player enters it.
    ...
    duplicate it until you have enough Lots to support your game's max players. You can safely put these lots inside
    ...
    each Lot, so if you want to split things up for organizational purposes that is fine. This is also a good
    way to get your scripts to run and get destroyed along with a Lot!
