--[[
    ...
    BroadcastEventComponentClient
        ...
        the event through Custom Property configuration or the Lua API.
    ...
    InteractionComponentTemplateClient
        ...
        This component is an example that can be used to create your components. It shows how each optional callback
        can be used. You should copy and paste the code out of this into your components and modify it to suit your
        needs.
    ...
    All of the above is managed through the use of pre-made Interaction Components. You can build your components
